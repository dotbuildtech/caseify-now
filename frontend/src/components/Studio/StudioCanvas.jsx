...
export default function StudioCanvas({ onCapture }) {
    ...
    return (
        <div className="flex flex-col items-center w-full overflow-hidden mx-auto max-w-[230px] sm:max-w-[300px] lg:max-w-[340px]">
            ...
            <div className="mt-3 flex w-full max-w-full items-center gap-3 overflow-hidden">
                <p className="min-w-0 truncate text-center text-[10px] font-semibold uppercase tracking-[0.25em] text-stone-400">
