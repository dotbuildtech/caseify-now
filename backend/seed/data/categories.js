const CATEGORIES = [
    { name: 'Mobile Back Covers', slug: 'mobile-back-covers', description: 'Protective and stylish covers for mobile phones' },
    { name: 'Screen Protectors', slug: 'screen-protectors', description: 'Tempered glass and film screen protectors' },
    { name: 'Chargers', slug: 'chargers', description: 'Wall chargers, fast chargers, wireless chargers' },
