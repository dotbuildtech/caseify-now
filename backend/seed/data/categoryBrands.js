const CATEGORY_BRANDS = {
    'Mobile Back Covers': [
        ...
        'huawei', 'sony', 'nokia', 'tecno', 'infinix', 'micromax', 'lava',
        'spigen', 'ringke', 'smartdevil', 'esr', 'uag', 'urbn'
    ],
    'Screen Protectors': [
        'apple', 'samsung', 'google', 'oneplus', 'xiaomi', 'nothing',
        'motorola', 'oppo', 'vivo', 'realme', 'iqoo', 'asus',
    ...
    'Power Banks': [
        ...
        'urbn', 'realme', 'oneplus', 'spigen', 'xiaomi', 'esr', 'sony'
    ],
    'Cables': [
        'anker', 'belkin', 'mi', 'spigen', 'portronics', 'ambrane',
        'urbn', 'esr', 'samsung', 'oneplus', 'realme', 'xiaomi',
...
module.exports = CATEGORY_BRANDS;
