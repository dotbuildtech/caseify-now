...
const { authLimiter, loginLimiter, registerLimiter, otpLimiter, forgotPasswordLimiter } = require('../middleware/rateLimiter');
...
router.post('/reset-password-with-otp', forgotPasswordLimiter, resetPasswordWithOTP);
